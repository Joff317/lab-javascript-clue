...
function selectRandom(arr) {
  let randomInteger = Math.floor(Math.random() * arr.length);

  if (randomInteger >= arr.length) {
    randomInteger--;
  }
...
function revealMystery(object) {
  ...
  const message = `${firstName} ${lastName} killed Mr. Boddy using the ${weaponName} in the ${roomName}!`;
  console.log(message);
  return message
}
